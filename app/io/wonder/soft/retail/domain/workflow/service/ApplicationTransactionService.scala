  ...
  )
{
  ...
  def updateAppTransaction(define: WorkflowStepEntity, currentStateEntity: WorkflowCurrentStateEntity): Either[Exception, WorkflowCurrentStateEntity] = {
  ...
  private def updateOrderRepository(define: WorkflowStepEntity, currentStateEntity: WorkflowCurrentStateEntity): Either[Exception, OrderEntity] = {
